...
class BrushEditCacheInvalidationSink implements CacheInvalidationSink {
  ...
  void invalidateBrushFrame(BrushFrameCacheInvalidation invalidation) {
    // 🚨★★★WHICH CHANGE, NEVER WHAT IT WENT BETWEEN. This log keeps 4,096
    // records for the life of the host; while the record carried the two
    // surfaces a change went between (2026-09-11 → 09-17), every stroke's
    ...
    // list). A record here names the change and nothing that lives.
