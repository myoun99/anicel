...
class _StoryboardPanelState extends State<StoryboardPanel> {
  ...
  RailSwipeRow<StoryboardRailRow>? _railRowAtY(double localY) {
  ...
  List<RailToggleColumn<StoryboardRailRow>> _railSwipeColumns() {
    ...
    final toggleTimesheet = widget.onToggleLayerTimesheet;
    final toggleTrackLane = widget.onToggleTrackLane;
    final toggleSeRowLane = widget.onToggleSeRowLane;
    ...
    Cut? cutOf(Track track) {
      ...
      return index < 0 ? null : _standing.cutAtPlayheadOn(index);
    }
  ...
  List<Widget> _railRowsForTrack(Track track, int index) {
    ...
    final vRows = <Widget>[
      _rows.trackDraggable(
        ...
        _playheadFollowing(
          (_) => StoryboardTrackLabelRow(
            ...
            subjectCut: _standing.cutAtPlayheadOn(index) ?? activeCut,
      ...
      if (widget.expandedTransformTracks.contains(track.id.value)) ...[
        ...
        // chain it names).
        ..._rows.draggableTrackEffectRows(
          track,
          _rows.transformLaneLabels(
            carrier: Layer(
    ...
    return [
      ...
      _sectionZoneGroup(
        ...
        rows: [_rows.transitionLabelRow(track)],
      ),
  ...
  Widget _trackGroupSection(
    ...
    return Stack(
      children: [
        ...
        Positioned.fill(
          child: IgnorePointer(child: _standing.trackStandingCellRing(track, scale)),
        ),
      ],
    );
  }
