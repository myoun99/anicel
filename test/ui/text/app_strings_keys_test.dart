...
void main() {
  final readers = <String, String Function(AppStrings)>{
    ...
    'recoverySnapshotsTitle': (s) => s.recoverySnapshotsTitle,
    'recoverySnapshotsHelp': (s) => s.recoverySnapshotsHelp,
    'appContainerTitle': (s) => s.appContainerTitle,
    'appContainerHelp': (s) => s.appContainerHelp,
    'recordingsFolderTitle': (s) => s.recordingsFolderTitle,
    'recordingsFolderHelp': (s) => s.recordingsFolderHelp,
    'conformCacheTitle': (s) => s.conformCacheTitle,
    'conformCacheHelp': (s) => s.conformCacheHelp,
    'containerEmpty': (s) => s.containerEmpty,
    'conformHoldingTemplate': (s) => s.conformHoldingTemplate,
    'autosaveEmptyNow': (s) => s.autosaveEmptyNow,
