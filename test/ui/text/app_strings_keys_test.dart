...
void main() {
  final readers = <String, String Function(AppStrings)>{
    ...
    'saveFailedTitle': (s) => s.saveFailedTitle,
    'saveFailedFileInUse': (s) => s.saveFailedFileInUse,
    'saveFailedReadOnly': (s) => s.saveFailedReadOnly,
    'saveFailedDiskFull': (s) => s.saveFailedDiskFull,
    'saveFailedLocationGone': (s) => s.saveFailedLocationGone,
    'saveFailedReplaceRefused': (s) => s.saveFailedReplaceRefused,
    'saveFailedUnknown': (s) => s.saveFailedUnknown,
    'saveFailedCopyKept': (s) => s.saveFailedCopyKept,
    'saveFailedNoCopy': (s) => s.saveFailedNoCopy,
    'saveFailedRetry': (s) => s.saveFailedRetry,
    'saveFailedDetailsHeading': (s) => s.saveFailedDetailsHeading,
    'failedCopyBackUp': (s) => s.failedCopyBackUp,
    'failedCopyPickTitle': (s) => s.failedCopyPickTitle,
    'failedCopyVanishOnClose': (s) => s.failedCopyVanishOnClose,
    'failedCopyBackingUp': (s) => s.failedCopyBackingUp,
    'failedCopyBackedUp': (s) => s.failedCopyBackedUp,
    ...
    'toolReadSource': (s) => s.toolReadSource,
    'toolReadReferences': (s) => s.toolReadReferences,
    'toolReadsEveryVisibleLayer': (s) => s.toolReadsEveryVisibleLayer,
    ...
    'railLayerBlendMode': (s) => s.railLayerBlendMode,
    ...
    'railBypassTrackFx': (s) => s.railBypassTrackFx,
    'railApplyTrackFx': (s) => s.railApplyTrackFx,
    'railRemoveFromTimesheet': (s) => s.railRemoveFromTimesheet,
    'railAddToTimesheet': (s) => s.railAddToTimesheet,
    'railCollapseLanes': (s) => s.railCollapseLanes,
    'railExpandLanes': (s) => s.railExpandLanes,
    'railOnionSkinOn': (s) => s.railOnionSkinOn,
    'railOnionSkin': (s) => s.railOnionSkin,
    'railFillReferenceOn': (s) => s.railFillReferenceOn,
    'railFillReference': (s) => s.railFillReference,
    ...
    'cnHeadDialogue': (s) => s.cnHeadDialogue,
    'cnHeadSeconds': (s) => s.cnHeadSeconds,
    'cnCoverCuts': (s) => s.cnCoverCuts,
    'cnCoverArtist': (s) => s.cnCoverArtist,
    'sheetPrintEpisode': (s) => s.sheetPrintEpisode,
    'sheetPrintTitle': (s) => s.sheetPrintTitle,
    'sheetPrintScene': (s) => s.sheetPrintScene,
    'sheetPrintCut': (s) => s.sheetPrintCut,
    'sheetPrintDuration': (s) => s.sheetPrintDuration,
    'sheetPrintName': (s) => s.sheetPrintName,
    'sheetPrintPage': (s) => s.sheetPrintPage,
    'sheetPrintRepeat': (s) => s.sheetPrintRepeat,
