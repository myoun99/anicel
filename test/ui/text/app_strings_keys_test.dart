...
void main() {
  final readers = <String, String Function(AppStrings)>{
    ...
    'tlSharedDeleteColour': (s) => s.tlSharedDeleteColour,
    'tlSharedKeepColour': (s) => s.tlSharedKeepColour,
    ...
    'mediaStillInUse': (s) => s.mediaStillInUse,
    ...
    'imRegisterInstead': (s) => s.imRegisterInstead,
    ...
    'toolStamp': (s) => s.toolStamp,
    'toolBucket': (s) => s.toolBucket,
    ...
    'tlSharedDelete': (s) => s.tlSharedDelete,
