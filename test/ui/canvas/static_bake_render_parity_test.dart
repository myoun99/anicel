...
class _SwappableSurface extends BitmapSurfacePainter {
  ...
  /// inspects a surface painter can tell WHERE — or whether — it changed.
  /// Saying so is not a concession to a cache: it is the honest answer, and
  /// a cache that believed otherwise would serve this stub's first frame for
