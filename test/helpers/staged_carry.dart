...
/// reader and the save take (`ProjectFile.mediaCarryFor`) — or null when
/// the pool points at the file, or names nothing there.
MediaCarry? carryIn(EditorSessionManager session, String path) =>
    session.repository.requireProject().mediaAssetByPath(path)?.carry;
